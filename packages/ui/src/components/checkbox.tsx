      ...
      <CheckboxPrimitive.Indicator
        ...
        render={(props, state) => (
          <span {...props}>
            {state.indeterminate ? (
              <svg
                className="size-[calc(--spacing(3)+var(--scale-offset)/2)]"
                fill="none"
                height="24"
                stroke="currentColor"
                strokeLinecap="round"
