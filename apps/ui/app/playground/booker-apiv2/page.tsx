...
export const metadata: Metadata = {
  title: "Booker Playground (API v2) - coss ui",
};
...
export default async function BookerApiv2Page() {
  const initialInput = {
    fetchMeta: true,
  ...
  return (
    <main className="container flex min-h-svh w-full items-center py-10">
      <Booker initialData={initialData} slotsSource="apiv2" target={target} />
    </main>
  );
}
