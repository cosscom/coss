---
name: coss-alert-dialog
description: Use when implementing critical confirmation flows with coss AlertDialog, especially destructive actions requiring explicit user intent.
