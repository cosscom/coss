---
name: coss-migration
description: Use when adapting shadcn/Radix code to coss/Base UI patterns. Covers asChild-to-render, naming differences, prop changes, and common migration mistakes.
...
For detailed per-component migration notes covering all 30+ components, see `references/component-index.md`.
