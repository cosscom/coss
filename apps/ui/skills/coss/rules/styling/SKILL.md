---
name: styling
description: Use when writing or reviewing Tailwind CSS classes in coss components. Covers semantic tokens, icon conventions, layout patterns, and data-slot selectors.
