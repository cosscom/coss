...
| Prop           | Type      | Default | Description                                      |
| -------------- | --------- | ------- | ------------------------------------------------ |
| `preventSwipe` | `boolean` | `false` | When true, prevents swipe-to-close when interacting with the header area |
...
| `preventSwipe` | `boolean`                | `true`      | When true, prevents swipe-to-close when interacting with the footer area |
...
| `preventSwipe` | `boolean` | `true`  | When true, prevents swipe-to-close when interacting with the panel content |

### DrawerMenu

Container for drawer menu items. Use with `DrawerMenuItem`, `DrawerMenuSeparator`, `DrawerMenuGroup`, and `DrawerMenuGroupLabel` to build menus that mirror the Menu component API. Supports the `render` prop for polymorphic composition.
...
Label for a `DrawerMenuGroup` section. Renders muted, smaller text above a group of items. Supports the `render` prop for polymorphic composition.
...
### Drawer with drag bar

<ComponentPreview name="p-drawer-2" />

### Drawer with close button (no footer)

<ComponentPreview name="p-drawer-3" />

### Inset variant (all positions)

<ComponentPreview name="p-drawer-4" />

### Straight variant (all positions)
...
### Nested drawers (bottom)

<ComponentPreview name="p-drawer-7" />

### Nested drawers (right)

<ComponentPreview name="p-drawer-8" />

### Snap points (bottom)

<ComponentPreview name="p-drawer-9" />

### Edit profile (default vs bare footer)

<ComponentPreview name="p-drawer-10" />
...
### Responsive (menu on desktop, drawer on mobile)
