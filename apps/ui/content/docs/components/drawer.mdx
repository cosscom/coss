...
| ------ | ---------------------------------------- | --------- | ------------------------------------------------ |
| `side` | `"right" \| "left" \| "top" \| "bottom"` | `"bottom"` | Controls which side the drawer opens from. Sets the swipe direction automatically and flows to child components via context |
...
| Prop              | Type                                      | Default     | Description                                      |
| ----------------- | ----------------------------------------- | ----------- | ------------------------------------------------ |
| `side`            | `"right" \| "left" \| "top" \| "bottom"`  | inherited   | Overrides the side from context. Typically not needed — set `side` on `Drawer` instead |
