...
- [Apr 17, 2026](/ui/docs/changelog#form) — **`Form`** no longer applies default layout classes; pass **`className`** where you need a stacked field layout (for example `flex w-full flex-col gap-4`).
