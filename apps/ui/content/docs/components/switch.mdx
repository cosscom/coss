...
<ComponentPreview name="particle-sw-1" />
...
<ComponentPreview name="particle-sw-2" />

### With Description

<ComponentPreview name="particle-sw-3" />

### Card Style

<ComponentPreview name="particle-sw-4" />

### Form Integration

<ComponentPreview name="particle-sw-5" />
