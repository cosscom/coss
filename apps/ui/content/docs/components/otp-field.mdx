...
- [Jun 21, 2026](/ui/docs/changelog#otp-field-base-ui-16) — Base UI OTP Field graduated from preview; import `OTPField` from `@base-ui/react/otp-field` (replaces `OTPFieldPreview`)
