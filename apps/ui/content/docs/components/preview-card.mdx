...
Popup container that displays the preview content. Also exported as `PreviewCardContent`.
...
Arrow pointing to the trigger. Styled wrapper for `PreviewCard.Arrow` from Base UI.
