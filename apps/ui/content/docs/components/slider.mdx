...
Track container for the slider. Styled wrapper for `Slider.Track` from Base UI.

### SliderIndicator

Visual indicator showing the current value range. Styled wrapper for `Slider.Indicator` from Base UI.

### SliderThumb

Draggable thumb element. Styled wrapper for `Slider.Thumb` from Base UI.
