...
The root component that wraps the autocomplete functionality. It's an alias for `Autocomplete.Root`.

| Prop       | Type                                   | Description                                      |
| ---------- | -------------------------------------- | ------------------------------------------------ |
| `items`    | `readonly unknown[]`                   | The array of items to display in the command     |
| `open`     | `boolean`                              | Controls whether the command is open             |
...
The API is significantly different from shadcn/ui (cmdk). Please review both docs before migrating: [cmdk Docs](https://cmdk.paco.me/) and [shadcn/ui Command](https://ui.shadcn.com/docs/components/command), and our Base UI Autocomplete docs referenced at the top of this page.
