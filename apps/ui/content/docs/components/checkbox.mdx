...
<ComponentPreview name="particle-cb-1" />
...
<ComponentPreview name="particle-cb-2" />

### With Description

<ComponentPreview name="particle-cb-3" />

### Card Style

<ComponentPreview name="particle-cb-4" />

### Form Integration

Field provides accessible labelling and validation primitives for form controls. Use it with `Form` to submit values.

<ComponentPreview name="particle-cb-5" />
