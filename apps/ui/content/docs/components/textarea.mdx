...
<ComponentPreview name="particle-tx-1" />
...
<ComponentPreview name="particle-tx-2" />

### Large Size

<ComponentPreview name="particle-tx-3" />

### Disabled

<ComponentPreview name="particle-tx-4" />

### With Label

<ComponentPreview name="particle-tx-5" />

### Form Integration

<ComponentPreview name="particle-tx-6" />
