...
<ComponentPreview name="particle-in-1" />
...
<ComponentPreview name="particle-in-2" />

### Large Size

<ComponentPreview name="particle-in-3" />

### Disabled

<ComponentPreview name="particle-in-4" />

### File

<ComponentPreview name="particle-in-5" />

### With Label

<ComponentPreview name="particle-in-6" />

### With Button

<ComponentPreview name="particle-in-7" />

### Form Integration

<ComponentPreview name="particle-fm-1" />
