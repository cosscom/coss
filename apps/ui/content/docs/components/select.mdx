...
Root component. Styled wrapper for `Select.Root` from Base UI.

| Prop   | Type                        | Default     | Description                                      |
| ------ | --------------------------- | ----------- | ------------------------------------------------ |
| `size` | `"sm" \| "default" \| "lg"` | `"default"` | Controls the size of the trigger and popup       |
...
Icon indicator for the trigger. Styled wrapper for `Select.Icon` from Base UI with chevron icon.
...
Checkmark indicator for selected items. Styled wrapper for `Select.ItemIndicator` from Base UI.
...
Scroll up indicator. Styled wrapper for `Select.ScrollUpArrow` from Base UI.

### SelectScrollDownArrow

Scroll down indicator. Styled wrapper for `Select.ScrollDownArrow` from Base UI.
