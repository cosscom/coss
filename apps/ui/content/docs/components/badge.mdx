...
```bash
npx shadcn@latest add https://coss.com/ui/r/badge.json
```
...
So, if you want to preserve the original shadcn/ui badge size, you should use the `lg` size in coss.com ui.
