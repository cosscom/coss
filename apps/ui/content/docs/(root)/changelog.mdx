...
coss ui now targets **`@daypicker/react@10.0.1`**. The legacy **`react-day-picker`** package name remains available for compatibility, but DayPicker recommends the scoped package for v10 and newer.
