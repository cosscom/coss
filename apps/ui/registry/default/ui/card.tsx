...
function CardPanel({
  ...
  const defaultProps = {
    className: cn(
      "p-6 in-[[data-slot=card]:has([data-slot=card-header]:not(.border-b))]:pt-0 in-[[data-slot=card]:has([data-slot=card-footer]:not(.border-t))]:pb-0",
      className,
    ),
