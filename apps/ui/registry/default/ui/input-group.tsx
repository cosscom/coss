  ...
  return (
    <div
      ...
      className={cn(
        ...
        "items-center min-w-0 has-[>*>textarea]:h-auto *:[&:is([data-slot=input-control],[data-slot=field-control],[data-slot=textarea-control])]:contents *:[&:is([data-slot=input-control],[data-slot=field-control],[data-slot=textarea-control])]:before:hidden",
