...
export const ui: Registry["items"] = [
  {
    ...
    files: [{ path: "ui/agent-response-feedback.tsx", type: "registry:ui" }],
  },
  {
    name: "agent-panel",
    type: "registry:ui",
    ...
    files: [{ path: "ui/agent-panel.tsx", type: "registry:ui" }],
  },
  {
    ...
    files: [{ path: "ui/agent-action-bar.tsx", type: "registry:ui" }],
  },
  {
    ...
    files: [{ path: "ui/agent-reasoning.tsx", type: "registry:ui" }],
  },
  {
    ...
    files: [{ path: "ui/agent-status-indicator.tsx", type: "registry:ui" }],
  },
  {
    ...
    files: [{ path: "ui/agent-tool-activity.tsx", type: "registry:ui" }],
  },
  {
    dependencies: ["class-variance-authority", "lucide-react"],
    files: [{ path: "ui/agent-composer.tsx", type: "registry:ui" }],
    name: "agent-composer",
    registryDependencies: [
      "@coss/button",
      "@coss/input-group",
  ...
  {
    dependencies: ["class-variance-authority", "lucide-react"],
    files: [{ path: "ui/agent-conversation.tsx", type: "registry:ui" }],
  ...
  {
    dependencies: ["lucide-react"],
    files: [{ path: "ui/agent-message.tsx", type: "registry:ui" }],
    name: "agent-message",
  ...
  {
    dependencies: ["class-variance-authority", "lucide-react"],
    files: [{ path: "ui/agent-message-actions.tsx", type: "registry:ui" }],
  ...
  {
    dependencies: ["class-variance-authority", "lucide-react"],
    files: [{ path: "ui/agent-approval.tsx", type: "registry:ui" }],
    name: "agent-approval",
    registryDependencies: [
      "@coss/badge",
      "@coss/button",
