...
export function SidebarGroupLabel({
  ...
  const defaultProps = {
    className: cn(
      "flex h-9 sm:h-8 shrink-0 items-center gap-2 rounded-lg px-2 font-medium text-sidebar-foreground text-sm sm:text-xs outline-hidden ring-sidebar-ring transition-[margin,opacity] duration-200 ease-linear focus-visible:ring-2 [&>svg]:size-4.5 sm:[&>svg]:size-4 [&>svg]:shrink-0",
...
export function SidebarMenuSkeleton({
  ...
  return (
    <div
      className={cn(
        "flex h-9 sm:h-8 items-center gap-2 rounded-lg px-2",
        className,
      )}
...
export function SidebarMenuSubButton({
  ...
  const defaultProps = {
    className: cn(
      "flex h-9 sm:h-8 min-w-0 -translate-x-px items-center gap-2 rounded-lg px-2 text-sidebar-foreground text-base sm:text-sm outline-hidden ring-sidebar-ring hover:bg-sidebar-accent/50 hover:text-sidebar-accent-foreground focus-visible:ring-2 disabled:pointer-events-none disabled:opacity-50 aria-disabled:pointer-events-none aria-disabled:opacity-50 sm:h-7 [&>span:last-child]:truncate [&>svg:not([class*='size-'])]:size-4.5 sm:[&>svg:not([class*='size-'])]:size-4 [&>svg]:shrink-0 [&>svg]:text-sidebar-accent-foreground",
