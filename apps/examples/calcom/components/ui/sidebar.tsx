...
export function SidebarGroupLabel({
  ...
  const defaultProps = {
    className: cn(
      "flex h-9 shrink-0 items-center gap-2 rounded-lg px-2 font-medium text-sidebar-foreground text-sm outline-hidden ring-sidebar-ring transition-[margin,opacity] duration-200 ease-linear focus-visible:ring-2 sm:h-8 sm:text-xs [&>svg]:size-4.5 [&>svg]:shrink-0 sm:[&>svg]:size-4",
...
export function SidebarMenuSubButton({
  ...
  const defaultProps = {
    className: cn(
      "flex h-9 min-w-0 -translate-x-px cursor-pointer items-center gap-2 rounded-lg px-2 text-base text-sidebar-foreground outline-hidden ring-sidebar-ring hover:bg-sidebar-accent/50 hover:text-sidebar-accent-foreground focus-visible:ring-2 disabled:pointer-events-none disabled:opacity-50 aria-disabled:pointer-events-none aria-disabled:opacity-50 lg:h-7 sm:text-sm [&>span:last-child]:truncate [&>svg:not([class*='size-'])]:size-4.5 sm:[&>svg:not([class*='size-'])]:size-4 [&>svg]:shrink-0 [&>svg]:text-sidebar-accent-foreground",
