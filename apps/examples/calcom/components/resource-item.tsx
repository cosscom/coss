...
export function ResourceItem({
  ...
  return (
    <Card
      className={cn(
        "translate-y-(--translate-y) transition-[background-color,box-shadow] has-[[data-slot=resource-item-title]:hover]:bg-[color-mix(in_srgb,var(--color-card),var(--color-black)_2%)] data-overlay:pointer-events-none data-dragged:bg-transparent data-dragged:opacity-64 data-dragged:shadow-none data-overlay:shadow-lg/5 data-dragging:transition-[background-color,opacity,translate,box-shadow] data-dragged:before:hidden dark:has-[[data-slot=resource-item-title]_a:hover]:bg-[color-mix(in_srgb,var(--color-card),var(--color-white)_2%)]",
        className,
      )}
