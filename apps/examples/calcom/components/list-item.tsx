...
export function ListItemDragHandle({
  ...
  return (
    <Button
      ...
      className={cn(
        "pointer-events-auto absolute inset-s-0 inset-y-px z-1 h-auto! cursor-grab items-start bg-transparent! pt-4.25 in-[[data-slot=list-item]:hover,[data-slot=list-item][data-drag-overlay],[data-drag-release]]:opacity-100 opacity-0 not-in-data-drag-release:transition-opacity in-[[data-slot=list-item]:hover]:delay-100 not-in-[[data-slot=list-item]:hover]:duration-50 focus-visible:opacity-100 focus-visible:ring-0 focus-visible:ring-offset-0 active:cursor-grabbing",
        className,
      )}
    ...
    >
      <GripVerticalIcon
        aria-hidden="true"
        className="in-[[data-slot=list-item-drag-handle]:focus-visible]:opacity-80 opacity-40"
      />
    </Button>
  );
}
